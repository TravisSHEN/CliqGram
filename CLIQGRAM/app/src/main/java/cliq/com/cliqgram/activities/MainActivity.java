...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    void showFragment(MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            case R.id.navigation_item_home:
                ...
                Snackbar.make(toolbar, "Home selected", Snackbar.LENGTH_SHORT).show();
                break;

            case R.id.navigation_item_profile:
                fragment = new ProfileFragment();
                title = getString(R.string.navigation_item_profile);
                Snackbar.make(toolbar, "Profile selected", Snackbar.LENGTH_SHORT).show();
                break;

            case R.id.navigation_item_activity:
                fragment = new ActivityFragment();
                title = getString(R.string.navigation_item_activity);
                Snackbar.make(toolbar, "Activity selected", Snackbar.LENGTH_SHORT).show();
                break;

            case R.id.navigation_item_setting:
                fragment = new SettingFragment();
                title = getString(R.string.navigation_item_setting);
                Snackbar.make(toolbar, "Setting selected", Snackbar.LENGTH_SHORT).show();
                break;
    ...
    private void showInitialSelectedFragment(Bundle savedInstanceState) {
        // if there is no pre-selected item, then show home fragment
